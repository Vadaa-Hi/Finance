...
document.querySelector(DOMstrings.dateLabel).textContent=unuudur.getFullYear()+' оны ' +unuudur.getMonth() +" сарын"
   ...
   getInput: function (){
       return {
           ...
           // parseInt => temdegtiig buhel too bolgono
           value: parseInt(document.querySelector(DOMstrings.inputValue).value)
       };
   },
displayPercentages:function(allPercentages){
    // Заррлагын Nodelist -ийг олох
    ...
    Expense.prototype.getPercentage = function(){
      ...
      return {
        tusuvTootsooloh: function(){
            ...
            calculateTotal('exp');
            //Төсвийг шиэнээр тооцоолно
            data.tusuv= data.totals.inc - data.totals.exp;
            // Орлого зарлагын хувийг тооцоолно
            if(data.totals.inc >0)
            data.huvi= Math.round((data.totals.exp / data.totals.inc)*100);
            else data.totals.inc = 0
        },
...
// Төсвийг шинэээр тооцоолоод дэлгэцэнд үзүүлнэ
updateTusuv();
...
document.querySelector(DOM.containerDiv).addEventListener("click",function(event){
    ...
    if (id ){
        ...
        // 2. Дэлгэж дээрээс энэ элементийг устгана
